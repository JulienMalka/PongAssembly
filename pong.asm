...
#----------------------
wait:
   addi t0, zero, 1  #might be useful
   slli t0, t0, 21 
   addi t1, zero, 1
   boucle:
     sub t0, t0, t1
...
move_paddles:
   ...
   cmpeqi t1, t1, 2
   andi t3, t7, 4 #get the 3th from end bit of edgeCapture
   cmpeqi t3, t3, 4
   andi t2, t7, 8 #get the 4th from end bit of edgeCapture
   cmpeqi t2, t2, 8
